...
public class Bird{ //Mon petit oiseau :D
	private ArrayList<Coordonnees> liste = new ArrayList<>(); //Permet de rï¿½cupï¿½rer tous les centres par lesquelles l'oiseau est passï¿½
	...
	public void deplace(){ //Dï¿½place les x et y selon le temps (T), Parabole codï¿½ en dur ï¿½ changer en alï¿½atoire !
